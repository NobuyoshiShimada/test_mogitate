...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = [
                ...
                'season_ids' => [$autumn->id, $winter->id]
                ],
                ...
                'season_ids' => [$summer->id, $autumn->id]
                ],
                [
                'name' => 'パイナップル',
                'price' => '800',
                ...
                'season_ids' => [$spring->id,$summer->id]
                ],
                [
                'name' => 'ブドウ',
                'price' => '1100',
        ...
        foreach ($data as $item) {
            $seasons = $item['season_ids'];
            unset($item['season_ids']);
